...
namespace tryAGI.Humanloop
{
    public partial interface IEvaluatorsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.Humanloop.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::tryAGI.Humanloop.AutoSDKHttpResponse<global::tryAGI.Humanloop.PaginatedEvaluatorResponse>> ListEvaluatorsAsResponseAsync(
            int? page = default,
            int? size = default,
            string? name = default,
            string? sortBy = default,
