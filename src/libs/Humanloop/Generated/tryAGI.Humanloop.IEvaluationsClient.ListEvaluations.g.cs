...
namespace tryAGI.Humanloop
{
    public partial interface IEvaluationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.Humanloop.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::tryAGI.Humanloop.AutoSDKHttpResponse<global::tryAGI.Humanloop.PaginatedEvaluationResponse>> ListEvaluationsAsResponseAsync(
            int? page = default,
            int? size = default,
            string? fileId = default,
            global::tryAGI.Humanloop.AutoSDKRequestOptions? requestOptions = default,
